...
class MayinTarlasi extends JFrame implements ActionListener, ContainerListener {
    ...
    public void setmanue() {
        ...
        final JCheckBoxMenuItem expart = new JCheckBoxMenuItem("Zor");
        final JCheckBoxMenuItem custom = new JCheckBoxMenuItem("Özel");
        final JMenuItem exit = new JMenuItem("Çıkış");
        final JMenu help = new JMenu("Yardım");
        ...
        custom.addActionListener(
                new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        Ozellestirme cus = new Ozellestirme();
                        reset();
                        panelb.revalidate();
                        panelb.repaint();
        ...
        helpitem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null, "|CopyRight| [14545523] Kadir Can Murat");
    ...
    class Ozellestirme extends JFrame implements ActionListener {
